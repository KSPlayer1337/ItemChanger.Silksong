...
public static class ItemNames
{
    ...
    public const string Blasted_Steps_Map = "Blasted_Steps_Map";
    public const string Choral_Chambers_Map = "Choral_Chambers_Map";
    public const string Cogwork_Core_Map = "Cogwork_Core_Map";
    public const string Cradle_Map = "Cradle_Map";
    public const string Deep_Docks_Map = "Deep_Docks_Map";
    public const string Far_Fields_Map = "Far_Fields_Map";
    public const string Grand_Gate_Map = "Grand_Gate_Map";
    public const string Greymoor_Map = "Greymoor_Map";
    public const string High_Halls_Map = "High_Halls_Map";
    public const string Hunter_s_March_Map = "Hunter's_March_Map";
    public const string Memorium_Map = "Memorium_Map";
    public const string Mosslands_Map = "Mosslands_Map";
    public const string Mount_Fay_Map = "Mount_Fay_Map";
    public const string Putrified_Ducts_Map = "Putrified_Ducts_Map";
    public const string Sands_of_Karak_Map = "Sands_of_Karak_Map";
    public const string Shellwood_Map = "Shellwood_Map";
    public const string Sinner_s_Road_Map = "Sinner's_Road_Map";
    public const string The_Abyss_Map = "The_Abyss_Map";
    public const string The_Marrow_Map = "The_Marrow_Map";
    public const string The_Slab_Map = "The_Slab_Map";
    public const string Underworks_Map = "Underworks_Map";
